...
# для удобства более короткое число будет a16
if len(a16) > len(b16):
    a16, b16 = b16, a16
...
# получая матрицу-ответ, но с элементами в 10-ричной системе
sm_sh = shifter(sm10)
mlt_sh = shifter(mlt10)
# формируем матрицу-ответ с элементами в 16-ричной системе
sm16 = _10_16(sm_sh)
mlt16 = _10_16(mlt_sh)
...
'''
print('сумма 10-ричная', sm10, sep='\t')
print('сумма + смещение', sm_sh, sep='\t')
print('сумма 16-ричная', sm16, sep='\t')
print()
print('произведение 10-ричное', mlt10, sep='\t')
print('произведение + смещение', mlt_sh, sep='\t')
print('произведение 16-ричное', mlt16, sep='\t')
'''
